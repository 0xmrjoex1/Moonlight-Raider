...
- **Which version of the Discord API does Moonlight Raider use?**
  - Moonlight Raider utilizes Discord API version 9 (v9).
...
- **What is Moonlight?**
  - Moonlight is a Discord raiding tool designed for raiding on Discord. It supports HTTP and HTTPS proxies, multi-threading, and includes features like joining and leaving servers, spamming, token checking, mass DMing, and more. It utilizes Discord API v9.
